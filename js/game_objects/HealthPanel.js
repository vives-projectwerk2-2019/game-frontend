...
class HealthPanel extends Phaser.GameObjects.Container {
  constructor(scene, x, y, children, id, healthvalue, shieldvalue, iTank) {
    ...
    let healthword = scene.add
      .text(x, y, "Health: ", { font: "Arial", fill: "#FF0000" })
      .setOrigin(0, 0);
    healthword.setFontSize(18);
    this.add(healthword); // Remove from scene and add to container
    y = y + 40;
    let shieldword = scene.add
      .text(x, y, "Shield: ", { font: "Arial", fill: "#FF0000" })
      .setOrigin(0, 0);
    ...
    this.newProgressBarHealth = new ProgressBar(
      this.scene,
      x,
      y,
      200,
    ...
    this.shieldvaluetext = scene.add
      .text(x, y, shieldvalue, { font: "Arial", fill: "#FF0000" })
      .setOrigin(0, 0);
