...
class startScreen extends Phaser.Scene {
    ...
    create() {
        ...
        const clickButton = this.add.text(this.cameras.main.centerX, this.cameras.main.centerY, "Press spacebar to start the game", 
            { 
                font: "72px Impact", 
                align: "center",
                padding: 10
        ...
        clickButton.setShadow(10, 10, 'black', 10);
    }
